...
public class BaseMatch {
    protected static TrieNode3[] _first;
    protected static int[] _keywordLength;
    protected static int[] _keywordIndex;
    protected static String[] _matchKeywords;

    /**
     * @param keywords 敏感词集合
     * @return
     */
    protected static List<TrieNode> BuildFirstLayerTrieNode(List<String> keywords) {
     ...
     * @return
     */
    protected static boolean HasMatch(String keyword) {
     ...
     * @throws Exception
     */
    protected static List<String> MatchKeywordBuild(String keyword) throws Exception {
     ...
     * @throws Exception
     */
    private static void SeparateParameters(String keyword, StringBuilder stringBuilder,
     ...
     * @throws Exception
     */
    public static void SetKeywords(List<String> keywords) throws Exception {
    ...
    protected static void SetKeywords2(List<String> keywords) {
